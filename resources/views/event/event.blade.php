...
<div class="card shadow">
  <div class="card-header">
    <div class="d-flex justify-content-between">
      ...
      <a href="{{ route('event.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm">
        <i class="fas fa-plus-circle fa-sm text-white-50"></i> Add Event</a>
    </div>
  </div>
  <div class="card-body">
    <table id="eventTables" class="table table-striped table-bordered" style="width:100%">
      <thead>
        <tr>
          <th>No</th>
          <th>Name</th>
